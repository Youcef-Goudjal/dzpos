...
/// This Event will be triggered when the user enters the
/// phone number and presses the otp button on the ui
...
///This event will be triggered when firebase sends the
///OTP to the user's phone number.
